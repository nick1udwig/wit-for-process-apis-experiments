            ...
            match request {
                ...
                WorkerRequest::Chunk {
                    ...
                    let file = match file {
                        ...
                        None => {
                            return Err(anyhow::anyhow!(
                                "ft_composed worker: receive error: no file initialized"
                            ));
                        }
                    };
                    ...
                    let bytes = match get_blob() {
                        ...
                        None => {
                            return Err(anyhow::anyhow!("ft_composed worker: receive error: no blob"));
                        }
                    };
                    ...
                    if let Some(size) = size {
                        ...
                        let main_app = Address {
                            ...
                            process: ProcessId::from_str(
                                "ft_composed:ft_composed:template.os",
                            )?,
                        };
